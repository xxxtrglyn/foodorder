...
function DishItemHorizontal({
  ...
  return (
    <div
      key={id}
      className="w-full sm:w-[calc(50%-16px)] lg:w-1/6 m-2 p-5 rounded-3xl shadow-md bg-slate-50 relative flex flex-col wrap"
    >
      <div>
...
export default DishItemHorizontal;
